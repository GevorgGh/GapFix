    ...
    public void onBindViewHolder(@NonNull HomeworkViewHolder holder, int position) {
        ...
        if (homework.solutionUrl != null) {
            ...
            if (homework.tutorFeedback != null) {
                holder.tvFeedbackBadge.setText("correct".equals(homework.tutorFeedback) ? "Correct" : "Incorrect");
                holder.tvFeedbackBadge.setTextColor("correct".equals(homework.tutorFeedback) ? 0xFF059669 : 0xFFDC2626);
            } else {
